...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (err.response?.status === 403
        && err.response?.data?.error === 'CUENTA_NO_VERIFICADA') {
        // Redirige a /verificar con el correo prellenado
        const correo = err.response.data.correo || formData.correo
        navigate('/verificar', { state: { correo } })
    } else {
