...
public class Usuario {
    ...
    @Column(name = "PasswordTemporal", nullable = false)
    @Builder.Default
    ...
    // Relación al departamento al que pertenece el usuario.
    // Un empleado de RH solo verá tickets de su área cuando tenga ese rol.
    @ManyToOne
